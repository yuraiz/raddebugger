...
REGS_UsageKind regs_g_reg_code_arm64_usage_kind_table[73] =
{
REGS_UsageKind_Normal,
REGS_UsageKind_Normal,
REGS_UsageKind_Normal,
...
String8 regs_g_reg_code_arm64_string_table[73] =
{
str8_lit_comp(""),
str8_lit_comp("x0"),
str8_lit_comp("x1"),
...
REGS_Rng regs_g_reg_code_arm64_rng_table[73] =
{
{0},
...
{(U16)OffsetOf(REGS_RegBlockARM64, elr_mode), 8},
{(U16)OffsetOf(REGS_RegBlockARM64, ra_sign_state), 8},
{(U16)OffsetOf(REGS_RegBlockARM64, tpidrro_elo), 8},
{(U16)OffsetOf(REGS_RegBlockARM64, tpidr_elo), 8},
{(U16)OffsetOf(REGS_RegBlockARM64, tpidr_el1), 8},
{(U16)OffsetOf(REGS_RegBlockARM64, tpidr_el2), 8},
{(U16)OffsetOf(REGS_RegBlockARM64, tpidr_el3), 8},
};
