...
internal REGS_RegCode reg_code_from_dw_reg_arm64(DW_Reg reg);
...
internal MACHINE_OP_REG_READ(regs_read_dwarf_arm64);
internal MACHINE_OP_REG_WRITE(regs_write_dwarf_arm64);
