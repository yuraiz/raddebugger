...
case REGS_RegCodeARM64_fp:{result = RDI_RegCodeArm64_fp;}break;
case REGS_RegCodeARM64_lr:{result = RDI_RegCodeArm64_lr;}break;
case REGS_RegCodeARM64_sp:{result = RDI_RegCodeArm64_sp;}break;
...
case REGS_RegCodeARM64_elr_mode:{result = RDI_RegCodeArm64_elr_mode;}break;
case REGS_RegCodeARM64_ra_sign_state:{result = RDI_RegCodeArm64_ra_sign_state;}break;
case REGS_RegCodeARM64_tpidrro_elo:{result = RDI_RegCodeArm64_tpidrro_elo;}break;
case REGS_RegCodeARM64_tpidr_elo:{result = RDI_RegCodeArm64_tpidr_elo;}break;
case REGS_RegCodeARM64_tpidr_el1:{result = RDI_RegCodeArm64_tpidr_el1;}break;
case REGS_RegCodeARM64_tpidr_el2:{result = RDI_RegCodeArm64_tpidr_el2;}break;
case REGS_RegCodeARM64_tpidr_el3:{result = RDI_RegCodeArm64_tpidr_el3;}break;
}
}break;
case Arch_x86:
{
...
case RDI_RegCodeArm64_fp:{result = REGS_RegCodeARM64_fp;}break;
case RDI_RegCodeArm64_lr:{result = REGS_RegCodeARM64_lr;}break;
case RDI_RegCodeArm64_sp:{result = REGS_RegCodeARM64_sp;}break;
...
case RDI_RegCodeArm64_elr_mode:{result = REGS_RegCodeARM64_elr_mode;}break;
case RDI_RegCodeArm64_ra_sign_state:{result = REGS_RegCodeARM64_ra_sign_state;}break;
case RDI_RegCodeArm64_tpidrro_elo:{result = REGS_RegCodeARM64_tpidrro_elo;}break;
case RDI_RegCodeArm64_tpidr_elo:{result = REGS_RegCodeARM64_tpidr_elo;}break;
case RDI_RegCodeArm64_tpidr_el1:{result = REGS_RegCodeARM64_tpidr_el1;}break;
case RDI_RegCodeArm64_tpidr_el2:{result = REGS_RegCodeARM64_tpidr_el2;}break;
case RDI_RegCodeArm64_tpidr_el3:{result = REGS_RegCodeARM64_tpidr_el3;}break;
}
}break;
case Arch_x86:
{
