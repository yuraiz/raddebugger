...
#include "macos/demon/demon_os_mac.h"
...
typedef struct DMN_MAC_ActiveTrap DMN_MAC_ActiveTrap;
struct DMN_MAC_ActiveTrap
{
  DMN_MAC_ActiveTrap *next;
  B32 good;
  DMN_Trap *trap;
  String8 swap_bytes;
};
...
typedef struct DMN_MAC_ProcessCtx
{
  ...
  DMN_MAC_ActiveTrap    *first_probe_trap;
  DMN_MAC_ActiveTrap    *last_probe_trap;
...
internal void                 dmn_mac_event_breakpoint(Arena *arena, DMN_EventList *events, DMN_MAC_ActiveTrap *user_traps, pid_t tid);
